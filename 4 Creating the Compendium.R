...
# 1 - COMPILE PACIFIC SALMON LEGISLATION----------------------------------------
## 1.1 - Using Type A Keyword Mapping to Compile Type B Legislation ----
### **1.1.1 - Download Type A Legislation HTML files ----
# Query CanLii website for (salmon OR sockeye OR chinook OR coho OR chum) - Type A Keywords
# Download html files to folder called Type A Legislation

### 1.1.2 - Parse Type A Legislation (heading, grouping paragraphs, and assigning section numbers) --------------------------------

# Define the directory containing HTML files
html_dir <- "C:/Users/ennsj/Documents/3. Management Domains/Interactive Tool/R Code/FA Trial/html_files/Type A Legislation"
